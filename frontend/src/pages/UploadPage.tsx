  ...
  return (
    <div className="max-w-7xl mx-auto p-8">
      <div className="flex justify-between items-end mb-6">
        <div>
          <h1 className="text-4xl font-bold">Data Import</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="col-span-2">
          {/* Drag & Drop Area */}
          <div 
            className="border-2 border-dashed border-gray-300 rounded-xl p-12 flex flex-col items-center justify-center text-center bg-gray-50 hover:bg-blue-50 hover:border-blue-300 transition-colors cursor-pointer relative"
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
            ...
            <ul className="space-y-4">
              {loading ? (
                ...
                history.map((record) => (
                  <li key={record.id} className="flex items-center justify-between border-b border-gray-100 pb-3">
